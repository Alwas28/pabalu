      ...
      <div style="padding:20px 24px;display:flex;flex-direction:column;gap:14px;max-height:68vh;overflow-y:auto">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
          ...
          <div style="grid-column:1/-1">
            ...
            <input name="name" class="f-input" required maxlength="150" placeholder="cth: Cuci Kiloan 5kg">
          </div>
          {{-- Kategori --}}
          <div>
          ...
          <div>
            ...
            <input name="unit" class="f-input" required maxlength="30" value="kg" list="unit-list-add"
              placeholder="kg, paket, pcs…">
            <datalist id="unit-list-add">
              <option value="kg"><option value="paket"><option value="pcs"><option value="helai">
              <option value="item"><option value="pasang"><option value="set">
            </datalist>
          </div>
          {{-- SKU --}}
          <div>
