...
@endpush
  ...
  <div style="display:flex;align-items:center;gap:8px;font-size:12.5px;color:var(--muted)">
    ...
    <span style="color:var(--text)">Tambah Produk Baru</span>
  </div>
          ...
          <div class="card-body">
            ...
            <div class="f-row">
              <div class="f-group">
                ...
                <select id="outlet_id" name="outlet_id" class="f-input" required>
                  ...
                  <option value="{{ $o->id }}" @selected(old('outlet_id') == $o->id)>{{ $o->nama }}</option>
                  @endforeach
                </select>
            ...
            <div class="f-group">
              ...
              <input id="nama" name="nama" type="text" class="f-input"
                value="{{ old('nama') }}" required placeholder="cth. Nasi Goreng Spesial">
            ...
            <div class="f-row">
              <div class="f-group">
                ...
                <input id="kode" name="kode" type="text" class="f-input"
                  value="{{ old('kode') }}" placeholder="cth. PRD-001" style="font-family:monospace">
                @error('kode')<div class="f-error"><i class="fa-solid fa-circle-exclamation" style="font-size:10px"></i>{{ $message }}</div>@enderror
              </div>
              <div class="f-group">
                ...
                <input id="satuan" name="satuan" type="text" class="f-input"
                  value="{{ old('satuan', 'porsi') }}" required placeholder="pcs, porsi, gelas…"
                  list="satuan-list">
                ...
                @error('satuan')<div class="f-error"><i class="fa-solid fa-circle-exclamation" style="font-size:10px"></i>{{ $message }}</div>@enderror
              </div>
            </div>
            ...
            <div class="f-group" style="margin-bottom:0">
              ...
              <div style="position:relative">
                ...
                <input id="harga_jual_display" type="text" class="f-input" inputmode="numeric" autocomplete="off"
                  ...
                  value="{{ old('harga_jual') ? number_format((int)old('harga_jual'), 0, ',', '.') : '' }}"
          ...
          <div class="card-body">
            ...
            <label for="gambar" id="img-drop-zone"
              style="display:flex;flex-direction:column;align-items:center;justify-content:center;
                     gap:8px;border:2px dashed var(--border);border-radius:12px;padding:24px 16px;
              ...
              <div style="font-size:13px;font-weight:600;color:var(--sub)">Klik atau seret foto ke sini</div>
