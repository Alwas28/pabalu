...
@php
  $methods = ['cash'=>['Tunai','fa-money-bill-wave','#34d399','rgba(16,185,129,.15)'],'qris'=>['QRIS','fa-qrcode','#60a5fa','rgba(99,162,241,.15)'],'qris_transfer'=>['QRIS Transfer','fa-qrcode','#818cf8','rgba(129,140,248,.15)'],'qris_pay'=>['QRIS Pay','fa-bolt','#fb923c','rgba(251,146,60,.15)'],'transfer'=>['Transfer','fa-building-columns','#a78bfa','rgba(139,92,246,.15)'],'card'=>['Kartu','fa-credit-card','#fbbf24','rgba(245,158,11,.15)']];
