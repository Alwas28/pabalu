...
class StockInController extends Controller
{
    ...
    public function index(Request $request, Outlet $outlet): View
    {
        ...
        return view('retail.stock-in.index', compact(
    ...
    public function create(Outlet $outlet): View
    {
        ...
        return view('retail.stock-in.create', compact('outlet', 'user', 'products'));
    }
    ...
    public function edit(Outlet $outlet, StockIn $stockIn): View
    {
        ...
        return view('retail.stock-in.edit', compact('outlet', 'user', 'stockIn', 'products', 'existingItems'));
    }
