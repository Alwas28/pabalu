...
class StockInController extends Controller
{
    ...
    public function index(Request $request, Outlet $outlet): View
    {
        ...
        return view('fnb.stock-in.index', compact(
    ...
    public function create(Outlet $outlet): View
    {
        ...
        return view('fnb.stock-in.create', compact('outlet', 'user', 'products'));
    }
    ...
    public function show(Outlet $outlet, StockIn $stockIn): View
    {
        ...
        return view('fnb.stock-in.show', compact('outlet', 'user', 'stockIn'));
    }
    ...
    public function edit(Outlet $outlet, StockIn $stockIn): View
    {
        ...
        return view('fnb.stock-in.edit', compact('outlet', 'user', 'stockIn', 'products', 'existingItems'));
    }
