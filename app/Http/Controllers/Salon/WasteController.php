...
class WasteController extends Controller
{
    ...
    public function index(Request $request, Outlet $outlet): View
    {
        ...
        return view('salon.waste.index', compact('outlet', 'user', 'wastes'));
    }
    ...
    public function create(Outlet $outlet): View
    {
        ...
        return view('salon.waste.create', compact('outlet', 'user', 'products', 'reasons'));
    }
    ...
    public function show(Outlet $outlet, Waste $waste): View
    {
        ...
        return view('salon.waste.show', compact('outlet', 'user', 'waste', 'reasons'));
    }
